...
class CustomDialogBoxWeb extends StatefulWidget {
  final String title, descriptions, text;
  //final Image img;

  const CustomDialogBoxWeb(
      {Key? key,
      required this.title,
  ...
  @override
  _CustomDialogBoxWebState createState() => _CustomDialogBoxWebState();
}

class _CustomDialogBoxWebState extends State<CustomDialogBoxWeb> {
  @override
