...
///////////// Route for Tables new/////////////////
  MyApp() {
    _router.define('/',
        handler: Handler(
          handlerFunc: (context, parameters) => VaccinationTable(),
        ));
    _router.define('/test',
        handler: Handler(
...
///////// Table Class //////////////////
class VaccinationTable extends StatefulWidget {
  @override
  _VaccinationTableState createState() => _VaccinationTableState();
}

class _VaccinationTableState extends State<VaccinationTable> {
  VaccinationTableSource _source = VaccinationTableSource();
          ...
          child: SingleChildScrollView(
            child: Container(
              ...
              child: BsCard(
                children: [
                  BsCardContainer(
                      title: Text('Vaccination Management'),
                      actions: [
                        TextButton(
                          onPressed: () {
                            _source.add({
                  ...
                  BsCardContainer(
                    child: BsDatatable(
                      ...
                      columns: VaccinationTableSource.columns,
