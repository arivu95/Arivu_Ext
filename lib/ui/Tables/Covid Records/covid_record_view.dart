...
import 'package:swaradmin/ui/Tables/Vaccination/vaccination_table.dart';

import 'covid_records_table.dart';
...
///////////// Route for Tables new/////////////////
  MyApp() {
    _router.define('/',
        handler: Handler(
          handlerFunc: (context, parameters) => CovidTable(),
        ));
    _router.define('/test',
        handler: Handler(
          handlerFunc: (context, parameters) => Covid(),
        ));
  }
...
///////// Table Class //////////////////
class CovidTable extends StatefulWidget {
  @override
  _CovidTableState createState() => _CovidTableState();
}

class _CovidTableState extends State<CovidTable> {
  CovidTableSource _source = CovidTableSource();
        ...
        body: Scrollbar(
          child: SingleChildScrollView(
            child: Container(
              ...
              child: BsCard(
                children: [
                  BsCardContainer(title: Text('Covid Management'), actions: [
                    TextButton(
                      onPressed: () {
                        _source.add({
                          'typecd': 'TP1',
                  ...
                  BsCardContainer(
                    child: BsDatatable(
                      ...
                      columns: CovidTableSource.columns,
