...
class AddCovidVaccine extends StatefulWidget {
  ...
  @override
  _AddCovidVaccineState createState() => _AddCovidVaccineState();
}

class _AddCovidVaccineState extends State<AddCovidVaccine> {
  int fieldCount = 0;
  int nextIndex = 0;
  ...
  @override
  void didUpdateWidget(AddCovidVaccine oldWidget) {
